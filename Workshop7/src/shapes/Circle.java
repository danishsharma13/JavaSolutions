...
public class Circle implements Shape {
	...
	public String toString() {
		...
		return String.format("%s {r=%s} perimeter = %g and area = %g", this.getClass().getSimpleName(),
				Double.toString(getRadius()), getPerimeter(), circleArea.getArea());
	}
}
