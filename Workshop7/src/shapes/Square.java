...
public class Square extends Rectangle {
	...
	public String toString() {
		...
		return String.format("%s {s=%s} perimeter = %6g and area = %g", this.getClass().getSimpleName(),
				Double.toString(getSide()), getPerimeter(), squareArea.getArea());
	}
}
